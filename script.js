$().ready(function() {
	...
	$(".page-header").append("<div><a href='../' style='color:white; font-weight:bold '><img src='img/home-5-16.png'></a> | <a href='../about' style='color:white; font-weight:bold '>about</a> | <a href='../exam' style='color:white; font-weight:bold '>exam</a></div>");
